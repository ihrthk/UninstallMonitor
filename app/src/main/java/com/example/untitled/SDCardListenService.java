...
public class SDCardListenService extends Service {

    SDCardListener[] listenners;

    @Override
    public void onCreate() {
        String filePath = Environment.getExternalStorageDirectory() + File.separator + "1.txt";

        SDCardListener[] listenners = {
                new SDCardListener("/data/data/com.example.untitled", this),
                new SDCardListener(filePath, this)};
